module.exports = {
	list(callback) {
		var sql = 'SELECT * from  dwpt_nortephotography.users';
	...
	readGoogle(id, callback) {
		var sql = "SELECT * from  dwpt_nortephotography.participantes where id_participante=?";
	...
	createGoogle(data, callback) {
		var sql = "INSERT INTO  dwpt_nortephotography.participantes ( nome_participante, username_part, email_part, id_participante, password_part) VALUES (?,?,?,?,?)";
		global.connection.query(
	...
	createFeedback(data, callback) {
		var sql = "INSERT INTO  dwpt_nortephotography.feedback ( nome_pessoal, email_pessoal, mensagem) VALUES (?,?,?)";
		global.connection.query(
	...
	updateParticipante(username, data, callback) {
		var sql = "UPDATE  dwpt_nortephotography.participantes SET nome_participante=?, email_part=?, password_part=?, tel_participante=?, username_part=? WHERE id_participante=?";
		global.connection.query(
...
var me = [];
	...
	readUsers(nome, callback) {
		var sql = "SELECT * from  dwpt_nortephotography.users where nome=?";
